...
var loadMore = function (that, call = "infolistReadyCallback") {
    ...
    var infodata = {
        pagesize: 10,
        p: page,
        diquid: that.data.diquidGetVlaue,
        leixingid: that.data.leixingidGetVlaue,
        keywords:that.data.keywords,
    };
    var infourl = "?c=samples&a=changdiList";
    setTimeout(function () {
...
Page({
    ...
    onLoad: function (options) {
        var that = this;
        page = 0;
        Entrance.optionAjax(that,"?c=samples&a=extcata","diquid","null","3", "地区"); //下拉框数据
        Entrance.optionAjax(that,"?c=samples&a=extcata","leixingid","null","25", "类型"); //下拉框数据
    ...
    cataClic: function (e,id,val) {
        ...
        that.setData({
            list: [],
            [id+"GetVlaue"]:that.data[id+"RangeValue"][val],
            scrollTop: 0,
